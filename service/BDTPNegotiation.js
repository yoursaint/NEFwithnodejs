...
// data schema
const bgtSchema = require('./JSONschema/Bgt.json');
const bgtPatchSchema = require('./JSONschema/BgtPatch.json');
 ...
 * af의 bdt resource management subscription 저장 및 조회
 * METHOD : GET, POST
...
router.post('/:afId/subscriptions', (req, res, next) => {
    let isValid = ajv.validate(bgtSchema, req.body);
...
router.patch('/:afId/subscriptions/:subscriptionId', (req, res, next) => {
    let isValid = ajv.validate(bgtPatchSchema, req.body);
